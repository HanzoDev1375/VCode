...
- **Built‑in Emmet Expansion** — type shorthand abbreviations like `ul>li.item*3` in HTML or `m10`, `d:f`, `jc:c` in CSS and instantly expand them into full code. The `!` abbreviation injects your custom HTML boilerplate with your cursor already inside `<body>`.
