...
public class TsLinter {
    ...
    private static final Pattern PAT_NONNULL = Pattern.compile("(\\w+)\\s*!");
    private static final Pattern PAT_ANY_TYPE = Pattern.compile(
            "(?::\\s*any\\b|<any>)");
    ...
    private static final Pattern PAT_OPTIONAL_BEFORE_REQUIRED = Pattern.compile(
            "\\(([^)]+)\\)");
    ...
    public static List<Problem> analyze(File file, String text) {
        ...
        checkTypeMismatch(file, text, lines, mask, problems);
        checkReturnAny(file, text, lines, mask, problems);
        checkNonNullOnNullable(file, text, lines, mask, problems);
        checkAnyType(file, text, lines, mask, problems);
        checkAsAssertion(file, text, lines, mask, problems);
        checkExportedFnReturnType(file, text, lines, mask, problems);
        checkOptionalBeforeRequired(file, text, lines, mask, problems);
        checkNamespace(file, text, lines, mask, problems);
        checkFunctionType(file, text, lines, mask, problems);
        checkEnum(file, text, lines, mask, problems);
        checkRedundantType(file, text, lines, mask, problems);
        checkHighNonNullAssertion(file, text, lines, mask, problems);
        checkUnionUndefined(file, text, lines, mask, problems);
        checkReadonlyArray(file, text, lines, mask, problems);
        checkInlineObjectType(file, text, lines, mask, problems);
    ...
    private static void checkTypeMismatch(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkReturnAny(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkNonNullOnNullable(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkAnyType(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkAsAssertion(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkExportedFnReturnType(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkOptionalBeforeRequired(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkNamespace(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkFunctionType(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkEnum(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkRedundantType(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkHighNonNullAssertion(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkUnionUndefined(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkReadonlyArray(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    private static void checkInlineObjectType(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
