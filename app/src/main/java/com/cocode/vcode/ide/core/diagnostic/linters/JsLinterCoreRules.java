...
public class JsLinterCoreRules {
    ...
    public static void checkConsole(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkDebugger(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkLooseEquality(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkEval(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkWith(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkNaNComparison(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkEmptyCatch(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkInfiniteLoop(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkSwitchDefault(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkPromiseChain(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
    ...
    public static void checkAsyncNoAwait(File file, String text, String[] lines, TokenMask mask, List<Problem> out) {
